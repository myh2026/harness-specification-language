...
[![Toolchain](https://img.shields.io/badge/toolchain-v0.2.14-success.svg)](#%EF%B8%8F-当前版本)
...
| `toolchain/tests/run_conformance.sh` | **双编译器一致性**：31 组用例，dhv ↔ dhv-ts「通过/失败」结论逐一对照 |
...
**v0.2.14**（工具链统一版本：dhv 0.2.13 · dhv-ts 0.2.13 · BNF v1.5.0 · 指南 v0.2.x）
